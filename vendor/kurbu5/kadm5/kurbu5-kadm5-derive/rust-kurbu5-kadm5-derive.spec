...
Version:        0.1.1
Release:        1%{?dist}
Summary:        Derive macros for KADM5_AUTH and KADM5_HOOK plugin interfaces
...
Derive macros for MIT Kerberos KADM5_AUTH and KADM5_HOOK
plugin modules implemented using the kurbu5-kadm5-rs crate.}
